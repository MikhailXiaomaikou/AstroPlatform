...
async def export_analysis_markdown(req: ReportRequest):
    ...
    lines.append("---")
    lines.append("*Generated by Astro Platform AI Spectrum Analyzer*")
...
async def export_chat_as_markdown(req: ChatMarkdownRequest):
    ...
    lines.append("*Generated by Astro Platform AI Research Assistant*")
...
async def export_workflow_as_python(req: WorkflowExportRequest):
    ...
    lines = [
        ...
        "Generated by Astro Platform AI Research Agent",
        f"Date: {datetime.now(timezone.utc).strftime('%Y-%m-%d %H:%M UTC')}",
        '"""',
        "",
        "import numpy as np",
