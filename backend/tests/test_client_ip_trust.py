...
def test_production_default_trusts_no_forwarded_headers():
    ...
    code = (
        ...
        "os.environ['DELETION_TOMBSTONE_KEY_ID'] = 'test-delete-v1';"
        ...
        "os.environ['PRIVACY_OPERATOR_NAME'] = 'Test Operator';"
        "os.environ['PRIVACY_CONTACT'] = 'privacy@example.invalid';"
        "os.environ['PRIVACY_JURISDICTION'] = 'Test Jurisdiction';"
        "from app.config import Settings;"
