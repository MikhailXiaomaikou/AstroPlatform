            ...
            <div style={{ display: "flex", gap: "0.4rem", margin: "0.75rem 0" }}>
              {selectedFile.fits_path && !isGenericWorkspaceFile && (
                <>
                  ...
                  <a href={`${import.meta.env.VITE_API_URL || (import.meta.env.DEV || import.meta.env.MODE === "test" ? "http://localhost:8000" : "https://astro-backend-h4x1.onrender.com")}/api/data/fits/download?fits_path=${encodeURIComponent(selectedFile.fits_path)}`}
